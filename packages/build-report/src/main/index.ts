/**
 * `@tsnuke/build-report-effect` — public surface of the Effect-TS report-builder slice.
 *
 * Implements RULE-004 (summary counts & rollup) and RULE-034 (schema version & `ok`).
 * A true strangler-fig slice: it CONSUMES `@tsnuke/score-effect` for the monorepo
...
// The diagnostic domain type — DE-VENDORED to `@tsnuke/contracts-effect` (the local
...
// Self-barrel: backs `import { BuildReport } from "@tsnuke/build-report-effect"`
