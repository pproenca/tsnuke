...
export default defineConfig({
  test: {
    ...
    // The `@ts-doctor/score-effect` dependency is a `file:` link whose entry point
    ...
    server: {
      deps: {
        // Both `@ts-doctor/score-effect` and `@ts-doctor/contracts-effect` (the
        ...
        inline: ["@ts-doctor/score-effect", "@ts-doctor/contracts-effect"],
      },
    },
  },
});
