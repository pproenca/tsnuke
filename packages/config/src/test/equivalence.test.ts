 ...
 *      `legacy/ts-doctor/packages/core/src/load-config.ts:22-154` is the oracle.
...
// ===========================================================================
// ORACLE: frozen copy of legacy/ts-doctor/packages/core/src/load-config.ts:22-154.
// Verbatim (only the `TsDoctorConfig` type import is inlined as `any`-shaped
