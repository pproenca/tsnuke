...
These tests **define "done"** for the Effect-TS rewrite of `tsnuke`'s **discovery**
module — the biggest core module (`legacy/tsnuke/packages/core/src/discover-ts-project.ts`,
