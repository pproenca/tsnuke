 ...
 *
 * Mirrors `legacy/ts-doctor/packages/ts-doctor/src/flags.ts:14` (`FailOn`) and
 * `packages/ts-doctor-rules/src/types.ts:13` (`Severity`). The literal *values*
...
/**
 * Diagnostic severity — ts-doctor v1 has `error` and `warning` only, deliberately
