...
These tests **define "done"** for the Effect-TS rewrite of `ts-doctor`'s exit-code
...
The legacy module is the oracle (`legacy/ts-doctor/packages/ts-doctor/src/exit-code.ts`,
