/**
 * `@tsnuke/filter-pipeline-effect` — public surface of the Effect-TS
...
// from `@tsnuke/contracts-effect` via `./Diagnostic.js` (the canonical Schemas).
...
export { ConfigSeverity, TsNukeConfig } from "./Config.js";
