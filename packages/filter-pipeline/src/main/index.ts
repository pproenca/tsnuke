/**
 * `@ts-fix/filter-pipeline-effect` — public surface of the Effect-TS
...
// from `@ts-fix/contracts-effect` via `./Diagnostic.js` (the canonical Schemas).
...
export { ConfigSeverity, TsFixConfig } from "./Config.js";
