...
import type { ConfigSeverity, TsNukeConfig } from "./Config.js";
 ...
 */
export function makeSeverityStage(config: TsNukeConfig): Stage {
...
export function makeIgnoreStage(config: TsNukeConfig): Stage {
...
const DISABLE_NEXT_LINE_RE = /\/\/\s*tsnuke-disable-next-line\s*(.*)$/;
 ...
 * `// tsnuke-disable-next-line <rule>` disables `<rule>` on the *following* line
