/**
 * `@ts-fix/module-graph-effect` — the GRAPH-tier module-graph builder.
 *
 ...
 *
 * The `ModuleGraph` TYPE is owned by — and imported from — `@ts-fix/rules-core-effect`;
...
// Self-barrel: backs `import { ModuleGraph } from "@ts-fix/module-graph-effect"`
