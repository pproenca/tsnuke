 ...
 * in the entire ts-doctor catalog that attaches a real `fix` payload: `kind:
 ...
 * `packages/ts-doctor-rules/src/rules/async/no-floating-promises.ts` — the fix
 ...
 * `defineRule` from `@ts-doctor/rules-core-effect`.
 */
