/**
 * `@tsnuke/rules-error-handling-effect` — the `error-handling` rule category
 ...
 * `packages/tsnuke-rules/src/rules/error-handling/`:
 *
...
// "@tsnuke/rules-error-handling-effect"` resolve to this module's namespace
