/**
 * `@tsnuke/rules-exhaustiveness-effect` — the `exhaustiveness` rule category
 ...
 * `packages/tsnuke-rules/src/rules/exhaustiveness/`:
 *
 ...
 * CONTRACTS (`Diagnostic`, `RuleMeta`) live in `@tsnuke/contracts-effect` and the
 * substrate (`defineRule`, `Rule`, `RuleContext`, `runRule`, `runTypeAwareRule`) in
 * `@tsnuke/rules-core-effect` — this slice consumes both and re-exports NOTHING it
...
// Self-barrel: `import { RulesExhaustiveness } from "@tsnuke/rules-exhaustiveness-effect"`
