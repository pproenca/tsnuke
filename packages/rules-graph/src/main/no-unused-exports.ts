 ...
 * `packages/ts-doctor-rules/src/rules/dead-code/no-unused-exports.ts`; the only change is
 * importing `defineGraphRule` from the `@ts-doctor/rules-core-effect` substrate rather than
