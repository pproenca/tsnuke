...
`/code-modernization:modernize-transform ts-doctor rules-type-performance effect`.

Source (READ-ONLY): `legacy/ts-doctor/packages/ts-doctor-rules/src/rules/type-performance/`
