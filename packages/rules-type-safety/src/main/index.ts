/**
 * `@tsnuke/rules-type-safety-effect` — the `type-safety` rule category
 * (RULE-006 + the RULE-025 type-safety row, "Type Safety"): 12 plain-TS predicates
 * ported verbatim from the legacy
 * `packages/tsnuke-rules/src/rules/type-safety/**`.
 *
 ...
 * `@tsnuke/rules-core-effect`. The data CONTRACTS (`Diagnostic`, `RuleMeta`,
 * `Rule`) live in `@tsnuke/contracts-effect` / `@tsnuke/rules-core-effect`
...
// Self-barrel: `import { RulesTypeSafety } from "@tsnuke/rules-type-safety-effect"`
