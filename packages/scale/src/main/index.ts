/**
 * `@tsnuke/scale-effect` — public surface of the Effect-TS scale slice.
 *
 * Two cleanly-separated halves of tsnuke's scale guard:
 *
...
// Self-barrel: lets consumers `import { Scale } from "@tsnuke/scale-effect"` and
