/**
 * Git ref-name guard (RULE-027, BC-15). FROZEN verbatim from react-doctor —
 * see legacy `packages/core/src/security/git-revision.ts:17-28`.
 *
 ...
 *
 * DORMANT (RULE-027): no git subprocess sink calls this yet — wire it when the
 * `--diff` path lands and assert invocation (TRANSFORMATION_NOTES.md Follow-ups).
 * Kept a plain synchronous pure predicate (Brief lines 25/91) — NOT `Effect`-wrapped.
 */
